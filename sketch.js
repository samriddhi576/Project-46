...
function spawnObstacles()
{
 ...
 if(frameCount % 90 === 0)
 {
    obstacle = createSprite(Math.round(random(displayWidth/2 - 700,displayWidth/2 + 700)), -displayHeight/2 ,20,20);
...
function spawnRewards()
{
  if(frameCount % 60 === 0)
  {
  reward = createSprite(random([displayWidth/2-500,displayWidth/2,displayWidth/2 +500]), -displayHeight/2 ,20,20);
  reward.velocityY = 8;
